...
export class HttpStubService {
  ...
  get(url: string): Observable<any> {
    ...
    } else if (url === 'https://api.punkapi.com/v2/beers/?page=1&per_page=25') {
      const allBeers = require('../../e2e/responses/all-beers.json');
      return of(allBeers);
    } else if (url === 'https://api.punkapi.com/v2/beers/?page=1&per_page=25&beer_name=Buzz') {
      const buzzBeer = require('../../e2e/responses/buzz-beer.json');
      return of(buzzBeer);
    } else if (url === 'https://api.punkapi.com/v2/beers/?page=1&per_page=25&brewed_before=2010-02') {
